...
## only TS
nnUNetv2_train 137 2d 0 -tr nnUNetTrainerCELoss --TS -pretrained_weights nnUNet_results/Brats2021_holdin/Dataset137_BraTS2021/nnUNetTrainerCELoss__nnUNetPlans__2d/fold_0/checkpoint_final.pth
